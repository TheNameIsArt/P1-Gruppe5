...
using UnityEngine.SceneManagement;
 ...
 //Script used to track if a button with a letter coresponds to the correct letter missing in the chosen word from wordGenerator
public class KeyboardScript : MonoBehaviour
{
    ...
    private void ShowThumbsDown()
    {
        ...
        Invoke("HideThumbsDown", 3f); // Hide after 1 second
